...
- Supports SQL Server username/password authentication through the universal desktop package.
...
- Unpublished release candidate. Native Windows authentication packaging was removed before the first public release.
